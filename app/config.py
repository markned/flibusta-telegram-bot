...
class Settings(BaseSettings):
    ...
    search_total_timeout_seconds: float = Field(default=35, alias="SEARCH_TOTAL_TIMEOUT_SECONDS")
    search_source_timeout_seconds: float = Field(default=25, alias="SEARCH_SOURCE_TIMEOUT_SECONDS")
    search_fallback_max_queries: int = Field(default=3, alias="SEARCH_FALLBACK_MAX_QUERIES")
