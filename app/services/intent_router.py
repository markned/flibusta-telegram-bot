...
KNOWN_SURNAMES={'толстой','достоевский','пелевин','сорокин','булгаков','оруэлл','хаксли','замятин','патту','остер','муравьев','муравьёв','мураками','герберт'}
KNOWN_AUTHOR_NAMES={
...
FIRST_NAMES={'эдит','лев','федор','фёдор','михаил','джордж','виктор','харуки','пол','томас','петр','пётр','константин','владимир','аркадий','антон','фрэнк'}
